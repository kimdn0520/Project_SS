...
- CommonPopup close anchor, pivot, position and size are preserved; the importer no longer recreates an existing common prefab. Current authored position is (648, -215).
