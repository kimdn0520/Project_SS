...
- `WindowTitleArt` applies the gold/cream nameplate to CommonPopup and menu panels, preserving the existing TMP title references and close buttons. `GoldTitle-v2.png` has genuine alpha and a cropped nine-slice sprite with 160/130/160/130 borders.
